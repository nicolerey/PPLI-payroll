    ...
    <?= form_open_multipart("employee_reports/{$action}", 'class="form-horizontal"');?>
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">     
            <input type="text" class="form-control datepicker" name="date" value="<?= (isset($data))?date_format(date_create($data['date']), 'm/d/Y'):"";?>" required<?= (isset($data) && $data['status'])?' disabled':'';?>/>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="title" value="<?= (isset($data))?$data['title']:'';?>" class="form-control" required<?= (isset($data) && $data['status'])?' disabled':'';?>/>
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label"><span class="fa fa-asterisk text-danger"></span> 
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <textarea name="body" class="form-control" rows="5" required<?= (isset($data) && $data['status'])?' disabled':'';?>><?= (isset($data))?$data['body']:'';?></textarea>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <?php endif;?>
            <div class="col-sm-4">
              <input type="file" name="image" id="image"<?= (isset($data) && $data['status'])?' disabled':'';?>/>
            </div>
          </div>
        </div>
